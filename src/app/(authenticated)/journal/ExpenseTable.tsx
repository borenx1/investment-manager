...
import AddEditExpenseTransactionDialog, {
  type Transaction,
} from '@/components/AddEditExpenseTransactionDialog';
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="flex items-center justify-center">
          <AddEditExpenseTransactionDialog transaction={tx}>
            <ActionAlertDialog
...
export default function ExpenseTable({ data: dataPromise }: { data: Promise<Transaction[]> }) {
